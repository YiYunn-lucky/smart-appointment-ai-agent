    ...
    def _initialize_prompt(self):
        ...
        self.prompt = PromptTemplate(
            ...
            template=(
                ...
                "或询问报修/上门预约的流程与所需信息（如'怎么报修'、'报修需要什么材料'、'如何预约师傅上门'"
                "——这类问法以促成报修为目的，应进入报修登记流程并逐项告知所需信息），"
                "例如'我家空调不制冷，帮我报修'、'想预约明天下午工程师上门修冰箱'、'请问报修需要提供什么信息？'。\n"
                ...
                "或笼统要求办理售后/联系售后人员（如'我要售后'、'找售后专员'、'想找个人处理售后'），"
                "例如'我要投诉你们的服务'、'帮我转人工客服'、'我要售后'。\n"
                "4. other（其他类）：与安居家电售后服务完全无关的请求，例如问天气、股票、闲聊等。\n"
                + tool_manifest +
                "举例说明：\n"
                "假如task为'空调不制冷，帮我预约个师傅上门看看'，则输出appointment。\n"
                "假如task为'请问报修需要提供什么信息？'，则输出appointment（询问报修流程等同于发起报修登记）。\n"
                "假如task为'保修期内想报修上门，流程怎么走？'，则输出appointment（核心意图是发起报修）。\n"
                "假如task为'我去年买的冰箱还在保修期内吗'，则输出query。\n"
                "假如task为'报修单AX20260903001现在什么进度了'，则输出query。\n"
                "假如task只包含一个11位手机号（如'13800138000'）而没有任何其他内容，则是客户在查询语境下"
                "提供联系方式以便查订单/保修，应输出query（消息仅手机号/数字属于查询意图）。\n"
                "假如task为'我的手机号是13800138000，帮我查下保修'，则输出query。\n"
                "假如task为'我要投诉维修师傅，给我转人工'，则输出complaint。\n"
                "假如task为'我要售后'或'帮我找售后专员处理'，则输出complaint（笼统要求办理售后，转人工登记由专员跟进）。\n"
                "假如task为'售后热线是多少'，则输出query（明确咨询售后渠道信息）。\n"
