...
class AppointmentProcessor:
    ...
    def update_history_from_data(self, appointment_history: Dict[str, Any], data: Dict[str, Any]) -> bool:
        ...
        # 只更新有值的字段，避免覆盖之前的信息
        for key in ["duration", "gender", "start_time", "project", "engineer_name"]:
        ...
        if not engineer_name or engineer_name == "未知":
            # 没有指定技师，需要性别来筛选
        ...
        if has_all_required and engineer_name and engineer_name != "未知":
    ...
    async def _process_successful_appointment(self, tech: Dict[str, Any], 
        ...
        start_time, end_time, duration_min = self.engineer_finder.parse_time_and_duration(
