...
class EngineerDBRouter:
    ...
    # 技师相关方法
    def add_engineer(self, name, gender=None, strength=None) -> None:
        return self.engineer_repo.add_engineer(name, gender, strength)
    ...
    def get_all_strengths(self):
        return self.engineer_repo.get_all_strengths()

    # 排班相关方法
    def add_schedule(self, engineer_id: int, start_time, end_time, status, appointment_id=None) -> None:
        return self.engineer_repo.add_schedule(engineer_id, start_time, end_time, status, appointment_id)
    ...
    def get_engineers_by_gender(self, gender: str):
        return self.engineer_repo.get_engineers_by_gender(gender)
