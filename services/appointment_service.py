...
class AppointmentService:
    ...
    def save_appointment(self, engineer_id: str, start_time: datetime, 
        ...
        try:
            ...
            logger.info(f"预约信息已保存到数据库：技师ID={engineer_id}, 时间={start_time} 到 {end_time}, 预约ID={appointment_id}")
            return True
    ...
    def add_engineer(self, name: str, gender: str = None, strength: str = None) -> Optional[int]:
        """添加新技师"""
        try:
