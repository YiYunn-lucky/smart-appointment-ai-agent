...
class UserBehaviorService:
    ...
    def record_behavior(self, user_id: str, action_type: str, action_data: Dict[str, Any] = None,
                       engineer_id: str = None, session_id: str = "default_session") -> bool:
        """记录用户行为"""
        try:
    ...
    def analyze_user_patterns(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # 分析偏好技师
            preferred_engineer = self._analyze_preferred_engineer(appointment_behaviors)
    ...
    def _analyze_preferred_engineer(self, appointment_behaviors: List[Dict[str, Any]]) -> Optional[str]:
        """分析偏好技师"""
        engineer_counts = {}
